...
<head> <link rel="shortcut icon" href="fav.png" type="image/png" > <title> MyResume </title>
	...
	{	$usid=mysql_result($queryrun,0,'name');
	 ...
	 if (isset($_POST['fname'])&& isset($_POST['lname'])&&isset($_POST['age'])&& isset($_POST['dob'])&&isset($_POST['paddress'])&& isset($_POST['aaddress'])&&isset($_POST['aphone'])&& isset($_POST['pphone'])&&isset($_POST['email'])&&isset($_POST['sch'])&& isset($_POST['gclg'])&&isset($_POST['pclg'])&& isset($_POST['10schname'])&& isset($_POST['10board'])&&isset($_POST['10per'])&& isset($_POST['12schname'])&&isset($_POST['12per'])&& isset($_POST['12board']))
				{
			...
			$query=" UPDATE `users` SET `lname`='".$lname."',`paddress`='".$paddress."',`aaddress`='".$aaddress."',`pphone`='".$pphone."',`aphone`='".$aphone."',`email`='".$email."',`gclg`='".$gclg."',`pclg`='".$pclg."',`collegename`='".$collegename."',`collegeboard`='".$collegeboard."',`collegeper`='".$collegeper."',`postcollegename`='".$postcollegename."',`postcollegeboard`='".$postcollegeboard."',`postcollegeper`='".$postcollegeper."' WHERE `id`='".$id."'";
...
<center>
<form action="updateresume.php" method="POST" role="form">
<table>
	<div class="from group">
			...
			<tr>
				...
				<td>Name : </td>
				<td><input type="text" readonly name="fname" placeholder="First Name*" value="<?php echo $fname; ?>" class="form-control" ></td> 
	...
	<div class="from group">
			<tr>
				<td>DOB :</td>  
				<td><input type="text" name="dob" readonly placeholder="Date Of Birth*" value="<?php echo $dob; ?>" class="form-control"></td>
  ...
  document.getElementById('sel3').value = "<?php echo $pclg;?>";
	...
	<div class="from group">
			<tr>
					...
					<td colspan="2"><input type="text" readonly name="10schname" placeholder="10th School Name*" value="<?php echo $sch10name; ?>"class="form-control"></td>
					<td><input type="text" readonly name="10board" placeholder="10th Board of Examination*" value="<?php echo $board10; ?>" class="form-control"></td>
					<td><input type="text" readonly name="10per" placeholder="10th Percentage*" value="<?php echo $per10; ?>" class="form-control"></td>
					
					
			</tr> 
			<tr>
					<td colspan="2"><input type="text" readonly name="12schname" placeholder="12th School Name*" value="<?php echo $sch12name; ?>" class="form-control"></td>
					<td><input type="text" readonly name="12board" placeholder="12th Board of Examination*"value="<?php echo $board12; ?>"  class="form-control"></td>
					<td><input type="text" readonly name="12per" placeholder="12th Percenatage*" value="<?php echo $per12; ?>" class="form-control"></td>
			</tr>
			<tr>
